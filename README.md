...
## Тема: Система управления пользовательскими запросами в техничекую поддкржку.
...
## Web-приложение «Helpdesk System» с автоматизированной инфраструктурой в AWS

Продуктовое веб-приложение для регистрации и обработки обращений в центр технической поддержки (Helpdesk), развернутое в отказоустойчивом облачном контуре по методологии **GitOps / DevSecOps**.
